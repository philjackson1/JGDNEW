...
public class GuiDComponent
{
	...
	public GuiDComponent(String cast,int no,int x,int y,iGuiDPropMessenger gpm)
	{
		...
		props = GuiDFileReaderProperties.getProperties(cast,no,x,y);
	...
	{
		compName = JOptionPane.showInputDialog("Name for this component e.g. lbl_Name");
			compText = JOptionPane.showInputDialog("Text to appear on this component e.g. Name:");
			...
			if(compText.equals(""))
			{
				compText = "NOT ENTERED";
			}
				
			props[8][2] = compText;
			props[0][2] = compName; //setName and line 486
	}
	...
	private void createComponent()
	{
		...
		else if(cast.equals("Checkbox")||cast.equals("JCheckBox")) //MSO:CheckBox->Checkbox
		{
		...
		else if(cast.equals("TextField")||cast.equals("JTextField"))
		{
			if(!props[8][2].equals("$"))
				...
				comp = new JTextField(Integer.parseInt(props[9][2]));
		}
...
//		props[0][2] = compName; //setName and line 486
		...
		//p1 is the JTextField
		//JTextField p1 = new JTextField(props[0][2],10);
		JTextField p1 = new JTextField(props[0][2]);
...
///////////////////////////////////////////////////////////////////
		...
		JTextField p2 = new JTextField(props[1][2]);
	...
	///////////////////////////////////////////////////////////////////
		...
		for(i=8;props[i][0]!=null;i++)
		{
			...
			{
				//props[i][2] = compText; //setText
				
				
				JTextField pi1 = new JTextField(props[i][2]);
				...
				pi1.addKeyListener(new KeyAdapter()
				{
					public void keyTyped(KeyEvent ke)
					{
						...
						if(props[j][0].equals("Label")||props[j][0].equals("Text"))
						{
							...
							{
								if(!props[j][2].equals(new String("$")))
	...
	public void printProps()
	{
		...
		for(int i=0;i<props.length;i++)
		{
			...
			for(int j=0;j<=2;j++)
			{
				currentLine=currentLine+props[i][j]+",";
			}
