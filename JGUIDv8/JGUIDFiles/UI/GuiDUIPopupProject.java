...
public class GuiDUIPopupProject extends JFrame implements ActionListener
{
	JLabel lblHeader;
	JButton app,japp,frm,jfrm,cmdExistingProject,cmdQuit;
	JFileChooser filechooser;
	iJGuiD msg;
    public GuiDUIPopupProject(iJGuiD m)
	{
		super("Project Dialog");
		msg = m;
	    Image myIcon = getToolkit().createImage("Images/icons/GuiD_icon.png");
	...
	public void openJFrameInstantly()
	{
		String type = "JFrame";
