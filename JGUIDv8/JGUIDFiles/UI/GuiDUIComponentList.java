...
public class GuiDUIComponentList extends JDesktopPane 
{
	...
	{
		setPreferredSize(new Dimension(165,800));
		...
		toolcont.setLayout(new GridLayout(0,1));
		//toolcont1 = new Container();
		//toolcont1.setLayout(new FlowLayout(FlowLayout.CENTER,0,20));

		but = new JButton(new ImageIcon("Images/component_icons/JButton.gif"));
		lbl = new JButton(new ImageIcon("Images/component_icons/JLabel.gif"));
		radbut = new JButton(new ImageIcon("Images/component_icons/JRadioButton.gif"));
		chk = new JButton(new ImageIcon("Images/component_icons/JCheckBox.gif"));
		txtfld = new JButton(new ImageIcon("Images/component_icons/JTextField.gif"));
		passfld = new JButton(new ImageIcon("Images/component_icons/JPasswordField.gif"));
		txtarea = new JButton(new ImageIcon("Images/component_icons/JTextArea.gif"));
		lst = new JButton(new ImageIcon("Images/component_icons/JList.gif"));
		cmb = new JButton(new ImageIcon("Images/component_icons/JComboBox.gif"));

		/*but1 = new JButton(new ImageIcon("Images/component_icons/Button.gif"));
		lbl1 = new JButton(new ImageIcon("Images/component_icons/Label.gif"));
		chk1 = new JButton(new ImageIcon("Images/component_icons/CheckBox.gif"));
		txtfld1 = new JButton(new ImageIcon("Images/component_icons/TextField.gif"));
		txtarea1 = new JButton(new ImageIcon("Images/component_icons/TextArea.gif"));
		lst1 = new JButton(new ImageIcon("Images/component_icons/List.gif"));
		cmb1 = new JButton(new ImageIcon("Images/component_icons/Choice.gif"));
		*/
...
*/
	...
	private void setActionCommands()
	{
		...
		chk1.setActionCommand("Checkbox");//MSO:CheckBox->Checkbox
